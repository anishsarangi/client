...
describe('AnnotationEditor', () => {
  ...
  describe('markdown content editor', () => {
    ...
    describe('tag editing', () => {
      ...
      it('trims tag when add callback invoked', () => {
        const wrapper = createComponent();
        wrapper.find('TagEditor').props().onAddTag(' newTag ');
      ...
      it('does not add empty tags', () => {
        const wrapper = createComponent();
        wrapper.find('TagEditor').props().onAddTag('  ');

        assert.notCalled(fakeTagsService.store);
    ...
    describe('saving the annotation', () => {
      ...
      it('checks for unsaved tags on save', async () => {
        const wrapper = createComponent();
        const inputEl = wrapper.find('TagEditor').props().tagInputRef;
        inputEl.current = {
          value: 'foobar',
        };
